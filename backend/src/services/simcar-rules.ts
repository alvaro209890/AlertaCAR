 ...
 */
import { detectCrs, layerBbox, parsePolygonRecords } from "./vertices-proximas.js";
import { parseDbfSchema } from "./shapefile-writer.js";
import type { GeometryErrorRow } from "./geometry-errors.js";
...
export const SIMCAR_LAYERS: LayerMeta[] = [
  ...
  { code: "NASCENTE", primitive: "point", aliases: ["NASCENTES", "OLHO_DAGUA", "OLHOS_DAGUA"] },
  {
    code: "RIO_MENOR_10",
    primitive: "polygon",
    aliases: ["RIO_ATE_10", "RIO_MENOR_10M", "RIOS_MENOR_10", "RIO_LT_10"],
  },
  {
    code: "RIO_10_ATE_50",
    primitive: "polygon",
    aliases: ["RIO_10_A_50", "RIO_10_50", "RIOS_10_ATE_50"],
  },
  {
    code: "RIO_50_ATE_200",
    primitive: "polygon",
    aliases: ["RIO_50_A_200", "RIO_50_200", "RIOS_50_ATE_200"],
  },
  {
    code: "RIO_200_ATE_600",
    primitive: "polygon",
    aliases: ["RIO_200_A_600", "RIO_200_600", "RIOS_200_ATE_600"],
  },
  {
    code: "RIO_MAIOR_600",
    primitive: "polygon",
    aliases: ["RIO_ACIMA_600", "RIO_MAIOR_600M", "RIOS_MAIOR_600", "RIO_GT_600"],
  },
  { code: "LAGO_LAGOA_NATURAL", primitive: "polygon", aliases: ["LAGOA_NATURAL", "LAGO_LAGOA", "LAGOA", "LAGO"] },
  { code: "RESERVATORIO_ARTIFICIAL", primitive: "polygon", aliases: ["RESERVATORIO", "REPRESA"] },
